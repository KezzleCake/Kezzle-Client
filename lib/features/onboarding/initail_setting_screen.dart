...
class _InitialSettingSreenState extends State<InitialSettingSreen> {
  ...
  void _onTapPickUpDate(BuildContext context) async {
    ...
    print(result);
    // void chageDate(DateTime date) {
    //   setState(() {
    //     _selectedDate = DateFormat('yyyy/MM/dd').format(date).toString();
    //   });
    // }
  ...
  void _onTapPickUpTime(BuildContext context) {
    showModalBottomSheet(
        context: context,
        builder: (context) {
          // return const CalendarWidget();
  ...
  void _onTapSkip(BuildContext context) {
    ...
    //   (route) => false,
    // );
    // context.pushReplacementNamed(MobileScreenLayout.routeName);
